define(['angular', 'given', 'util'], function(angular, given, util) {
  ...
  describe('services', function() {
    describe('MyModel service', function() {
      ...
      it('has loopback sdk methods including aliases', function() {
      ...
      it('can create new resource', function() {
        var obj;
        return MyModel.create({ name: 'new' }).then(function(o) {
          obj = o;
          expect(obj).to.have.property('name', 'new');
        })

        .then(function() {
          return MyModel.findById(obj.id).then(
            function(found) {
      ...
      it('can save a new resource', function() {
        //var obj = MyModel.new();
        //obj.name = 'new-saved';
        var obj = {name: 'new-saved'};

        return MyModel.put(obj).then(
          function(res) {
            obj = res;
      ...
      it('can save an existing resource', function() {
        var obj;
        return MyModel.create({ name: 'create-save' })

        .then(
          function(res) {
            obj = res;
            obj.updated = true;
            return obj.save().then(function(){}, util.throwHttpError);
          },
          util.throwHttpError
        )
